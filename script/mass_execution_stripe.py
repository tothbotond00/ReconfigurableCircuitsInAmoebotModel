...
program1 = "python stripe.py"  # or "./program_a" for compiled binaries
program2 = "python stripe.py"
output_csv = "results_100_stripe_2.csv"
...
with open(output_csv, mode="w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow([
        "file","executionTime","steps","executionTimeIcycle", "stepsIcycle"
    ])
    ...
    for file in sorted(os.listdir(folder1)):
        ...
        writer.writerow([
            file,
            res_variables1['time'],
            res_variables1['steps'],
            res_variables2['time'],
            res_variables2['steps']
        ])
